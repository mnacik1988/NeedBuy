...
function systemPrompt() {
  return [
    ...
    '   В обороте «к чему-то» само это НЕ товар, оно лишь ориентир и обычно',
    '   уже есть дома: «что-нибудь к чаю» — это печенье, конфеты, лимон,',
    '   но НЕ чай; «к ужину» — не ужин; «к празднику» — не праздник.',
    '   Разворачивай сдержанно: три-четыре товара, а не всё подряд.',
